...
Global CompatibleNumber$ = "1.3.8" ;Only change this if the version given isn't working with the current build version - ENDSHN
...
Font1% = AALoadFont("GFX\font\cour\Courier New.ttf", Int(20 * (GraphicHeight / 1024.0)), 0,0,0)
